...
/**
 * This class loads in the music and plays them.
 */
...
public class JukeBox {
	...
	//takes in the string and an int which is where you want the sound clip frame to return to.
	...
	//resumes music stopped.
	public static void resume(String s) {
		if(clips.get(s).isRunning()) return;
		clips.get(s).start();
	}
	
	//resumes a loop to playing
	...
	//Takes in a string then plays the music from the start frame to the end frame and returns to the frame
	//indicated and replays through.
